...
legend("topleft",c("£5.0","£5.5", "£6.0","£6.5"),cex=.8,col=c("blue","red","orange","green"),pch=c(16,16,16,16))


plot(AvgRegretTS,type="l",col = "red",
     main = "Average Regret",
     xlab = "Time", ylab = "Regret")
